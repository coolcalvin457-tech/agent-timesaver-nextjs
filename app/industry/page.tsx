...
export const metadata = {
  ...
  description:
    "A free industry intel briefing. Tailored to your role and what matters this week. Built in minutes from four questions.",
  openGraph: {
    title: "AGENT: Industry · Prompt AI Agents",
    description:
      "A free industry intel briefing. Tailored to your role and what matters this week. Built in minutes from four questions.",
...
export default function IndustryIntelPage() {
  return (
    <>
      <Nav dark />
      <main style={{ background: "linear-gradient(180deg, #14151A 0%, #0A0A0C 100%)", minHeight: "100vh" }}>
