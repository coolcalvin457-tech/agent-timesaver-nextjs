...
const coachingTiers: Tier[] = [
  {
    badge: "Starter",
    name: "3 Sessions",
    tagline: "Learn the basics. Build your first agent.",
    price: "$500",
    priceNote: "3 personal sessions, 1-on-1 with Calvin.",
    features: [
      "Three 1-hour live sessions",
      "Curriculum from the real build journey",
      "Prompting and context, in plain English",
      "Walk away with your own working agent",
    ],
    ctaLabel: "Join the Waitlist",
    ctaHref: "mailto:calvin@promptaiagents.com?subject=AI%20Coaching%20Waitlist%20-%20Starter",
    ctaStyle: "outline",
  },
  {
    badge: "Growth",
    name: "8 Sessions",
    tagline: "Go deeper. Build a real system.",
    price: "$2,000",
    priceNote: "8 personal sessions, 1-on-1 with Calvin.",
    features: [
      "Eight 1-hour live sessions",
      "Full curriculum: prompting, context, scaling",
      "Build multiple agents across real workflows",
      "Ongoing feedback between sessions",
    ],
    ctaLabel: "Join the Waitlist",
    ctaHref: "mailto:calvin@promptaiagents.com?subject=AI%20Coaching%20Waitlist%20-%20Growth",
    ctaStyle: "outline",
  },
  {
    badge: "Scale",
    name: "Team & Custom",
    tagline: "Train your team. Or audit your business.",
    price: "$5,000",
    priceNote: "Pick one. Or combine, if it fits.",
    features: [
      "15 personal 1-on-1 sessions",
      "Or a full-day team training session",
      "Or an AI audit for a small business",
      "Custom scope, shaped to the outcome",
    ],
    ctaLabel: "Join the Waitlist",
    ctaHref: "mailto:calvin@promptaiagents.com?subject=AI%20Coaching%20Waitlist%20-%20Scale",
    ctaStyle: "outline",
  },
];
