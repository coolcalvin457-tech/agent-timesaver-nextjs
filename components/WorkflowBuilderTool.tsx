...
export default function WorkflowBuilderTool({
  ...
  return (
    ...
    >
        ...
        <div className="screen">
          ...
          <div style={fieldGroupStyle}>
            ...
            <div style={{ position: "relative" }}>
              <textarea
                id="wf-task"
                style={{ ...textareaStyle, fontSize: "0.875rem", minHeight: "210px", padding: "14px 16px", paddingBottom: "32px" }}
          ...
          <div style={{ marginTop: "-12px", marginBottom: "8px", display: "flex", flexDirection: "column" as const, alignItems: "center" }}>
      ...
      {/* ── Paywall ───────────────────────────────────────── */}
      {screen === "paywall" && (
        <div ref={paywallRef} className="screen" style={{ background: "#161618", scrollMarginTop: "100px" }}>
          <h2
            style={{
